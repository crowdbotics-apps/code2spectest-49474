"""
Django settings for code2spectest_49474 project.
...
ROOT_URLCONF = 'code2spectest_49474.urls'
...
WSGI_APPLICATION = 'code2spectest_49474.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "code2spectest Support <support@code2spectest-49474.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "code2spectest_49474 API",
    "DESCRIPTION": "API documentation for code2spectest_49474 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "code2spectest_49474.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "code2spectest_49474.storage_backends.AzureStaticStorage"
